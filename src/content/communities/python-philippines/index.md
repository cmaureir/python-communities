...
For more info, check out: [https://python.ph](https://python.ph)
...
To make clear what is expected, all delegates/attendees, speakers, exhibitors, organizers, and volunteers at any PythonPH event are required to conform to the following **[Code of Conduct](https://www.python.org/psf/conduct/)**.

**Contact Information**

If you believe that someone is violating the Code of Conduct, or have any other concerns, please contact a member of the PythonPH Code of Conduct workgroup immediately. They can be reached by emailing [board@python.ph](mailto:board@python.ph).
